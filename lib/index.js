  ...
  async execute(job, request) {
    try {
      ...
      if (job.abort.signal.aborted) {
        ...
        job.error = /UNSUPPORTED_REASONING_EFFORT|does not support reasoning effort/i.test(message) ? "\u8BE5\u6A21\u578B\u4E0D\u652F\u6301\u5F53\u524D\u601D\u8003\u6863\uFF0C\u5DF2\u6309\u65E0\u601D\u8003\u91CD\u8BD5\u4ECD\u5931\u8D25\u3002\u8BF7\u6362\u4E00\u4E2A dsh \u91CC\u80FD\u6B63\u5E38\u5BF9\u8BDD\u7684\u6A21\u578B\u3002" : message;
      }
    } finally {
      job.done = true;
